...
GitHub kann Verbindungsdaten, IP-Adressen und andere technische Informationen bei jedem Besuch dieser Website erfassen. Die Datenverarbeitung dient der Gewährleistung eines sicheren und stabilen Websitebetriebs sowie der Analyse und Verbesserung des Dienstes.

Weitere Informationen finden Sie in der Datenschutzerklärung von GitHub: [https://docs.github.com/de/site-policy/privacy-policies/github-privacy-statement](https://docs.github.com/de/site-policy/privacy-policies/github-privacy-statement)
...
Als Arztpraxis unterliegen wir besonderen datenschutzrechtlichen Pflichten. Die Verarbeitung von Gesundheitsdaten unserer Patienten erfolgt ausschließlich auf Grundlage der ärztlichen Schweigepflicht und den Bestimmungen der DSGVO.

Patientendaten werden ausschließlich zum Zwecke der Behandlung und Abrechnung sowie zur Erfüllung der sich aus dem Behandlungsvertrag ergebenden Pflichten verarbeitet. Eine Weitergabe an Dritte erfolgt nur mit Ihrer Einwilligung oder soweit dies gesetzlich vorgeschrieben ist (z.B. an Krankenkassen zur Abrechnung).

---

**Stand:** Dezember 2025

Quelle: Diese Datenschutzerklärung wurde erstellt in Anlehnung an die Vorgaben der DSGVO und des BDSG.
